...
impl<'a> TableIndex<'a> {
  ...
  pub const VT_CORE_INDEX: flatbuffers::VOffsetT = 6;
  pub const VT_SERIES_INDEX: flatbuffers::VOffsetT = 8;
  pub const VT_MAX_VERSION: flatbuffers::VOffsetT = 10;
  pub const VT_KEY_COUNT: flatbuffers::VOffsetT = 12;
  pub const VT_UNCOMPRESSED_SIZE: flatbuffers::VOffsetT = 14;
  pub const VT_ON_DISK_SIZE: flatbuffers::VOffsetT = 16;
  pub const VT_STALE_DATA_SIZE: flatbuffers::VOffsetT = 18;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.series_index { builder.add_series_index(x); }
    if let Some(x) = args.core_index { builder.add_core_index(x); }
  ...
  #[inline]
  pub fn core_index(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(TableIndex::VT_CORE_INDEX, None)}
  }
  #[inline]
  pub fn series_index(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(TableIndex::VT_SERIES_INDEX, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for TableIndex<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("core_index", Self::VT_CORE_INDEX, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("series_index", Self::VT_SERIES_INDEX, false)?
...
pub struct TableIndexArgs<'a> {
    ...
    pub core_index: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
    pub series_index: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
    pub max_version: u64,
    pub key_count: u32,
...
impl<'a: 'b, 'b> TableIndexBuilder<'a, 'b> {
  ...
  #[inline]
  pub fn add_core_index(&mut self, core_index: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TableIndex::VT_CORE_INDEX, core_index);
  }
  #[inline]
  pub fn add_series_index(&mut self, series_index: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TableIndex::VT_SERIES_INDEX, series_index);
  }
  #[inline]
...
impl core::fmt::Debug for TableIndex<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("TableIndex");
      ...
      ds.field("core_index", &self.core_index());
      ds.field("series_index", &self.series_index());
