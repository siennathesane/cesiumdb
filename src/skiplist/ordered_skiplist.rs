    ...
    T: cmp::PartialOrd,
{
    ...
    ///
    /// ```
    /// use crate::cesiumdb::skiplist::ordered_skiplist::OrderedSkipList;
    ///
...
impl<T> OrderedSkipList<T> {
    ...
    /// Returns an `Option<&T>` pointing to the lowest element whose key is
    /// above the given bound. If no such element is found then `None` is
    /// returned.
    ///
    /// # Examples
    ///
    ...
    /// Returns an `Option<&T>` pointing to the highest element whose key is
    /// above the given bound. If no such element is found then `None` is
    /// returned.
    ///
    /// # Examples
...
mod tests {
    ...
    use crate::skiplist::ordered_skiplist::OrderedSkipList;
